...
open class DpmSource_UnitTestBase {
    ...
    companion object {
        ...
        fun assertMetricsBlueprint(blueprint: CodeListBlueprint) {
        ...
        fun assertExplicitDomainsAndHierarchiesBlueprint(blueprint: CodeListBlueprint) {
            assertThat(blueprint.usesExtensions).isTrue()
            assertThat(blueprint.extensionPropertyTypeUris).containsExactly(
        ...
        fun assertTypedDomainBlueprint(blueprint: CodeListBlueprint) {
            assertThat(blueprint.usesExtensions).isTrue()
            assertThat(blueprint.extensionPropertyTypeUris).containsExactly(
        ...
        fun assertExplictOrTypedDimensionsBlueprint(blueprint: CodeListBlueprint) {
            assertThat(blueprint.usesExtensions).isTrue()
            assertThat(blueprint.extensionPropertyTypeUris).containsExactly(

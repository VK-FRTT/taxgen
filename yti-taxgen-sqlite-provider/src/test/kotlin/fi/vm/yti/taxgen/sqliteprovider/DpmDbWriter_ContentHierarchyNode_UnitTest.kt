        ...
        return listOf(
            ...
            dynamicTest("should have correct HierarchyNode structure") {
                ...
                assertThat(rs.toStringList()).containsExactlyInAnyOrder(
                    ...
                    "ExpDomHier-1-Code, Mbr-4-Lbl-Fi, Mbr-4-Code, Mbr-3-Code, Mbr-3-Lbl-Fi, 3, 4, nil",
            ...
            dynamicTest("should have HierarchyNodes with Member, Concept and Owner relation") {
                ...
                assertThat(rs.toStringList()).containsExactlyInAnyOrder(
                    ...
                    "ExpDomHier-1-Code, Mbr-4-Lbl-Fi, Mbr-4-Code, nil, nil, 0, HierarchyNode, 2018-09-03 10:12:25Z, 2018-09-03 22:10:36Z, 2018-02-22, 2018-05-15, FixName",
